  ...
  return (
    <aside className="space-y-8 lg:self-start lg:pt-1">
      <section className="border border-neutral-200 bg-white">
        ...
        <div className={`px-6 pb-6 md:-mt-1 md:pb-4 ${isOpen('quick-facts') ? 'block' : 'hidden'}`}>
          {quickFacts.length ? (
      ...
      <section className="border border-neutral-200 bg-white">
        ...
        <div className={`px-6 pb-6 md:-mt-1 md:pb-4 ${isOpen('past-exhibitions') ? 'block' : 'hidden'}`}>
      ...
      <section className="border border-neutral-200 bg-white">
        ...
        <div className={`px-6 pb-6 md:-mt-1 md:pb-4 ${isOpen('future-plans') ? 'block' : 'hidden'}`}>
          <ul className="space-y-2 text-sm text-neutral-800 md:space-y-1.5 md:text-[1.04rem] md:leading-relaxed">
      ...
      <section className="border border-neutral-200 bg-white">
        ...
        <div className={`px-6 pb-6 md:-mt-1 md:pb-4 ${isOpen('community-links') ? 'block' : 'hidden'}`}>
          <ul className="space-y-2 text-sm text-neutral-800 md:space-y-1.5 md:text-[1.04rem] md:leading-relaxed">
